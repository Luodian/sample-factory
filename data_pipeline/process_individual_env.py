...
def sample_single_env(env_name, checkpoint_dir, output_dir, frames_per_env, max_episodes, randomness, epsilon_greedy=0.0, save_video=False, device='cpu'):
    ...
    args = (experiment, checkpoint_dir, output_dir, frames_per_env, max_episodes, device, randomness, epsilon_greedy, save_video)
...
def main():
    ...
    parser.add_argument('--save-video', action='store_true',
                        help='Save video file for each episode')
